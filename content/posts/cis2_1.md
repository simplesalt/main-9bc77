...
excerpt: "CIS 2.1 contains the core mission of CIS 2: have an accurate Software Inventory.\_ The other CIS 2 controls are just supporting ways that help deliver that\_core mission.\_"
date: '2020-12-10'
seo:
  title: CIS 2.1 - the Mission
  description: "CIS 2.1 contains the core mission of CIS 2: have an accurate Software Inventory.\_"
  extra:
    - name: 'og:type'
      value: article
      keyName: property
    - name: 'og:title'
      ...
      keyName: property
    - name: 'og:description'
      value: "CIS 2.1 contains the core mission of CIS 1: have an accurate Software Inventory.\_"
      keyName: property
    - name: 'og:image'
